...
#define CH_DBG_STACK_FILL_VALUE             0//0x55
#endif
...
extern "C" {
  ...
  void _dbg_check_lock_from_isr(void) __ONCHIP_CODE__;
  void _dbg_check_unlock_from_isr(void) __ONCHIP_CODE__;
  void _dbg_check_enter_isr(void) __ONCHIP_CODE__;
  void _dbg_check_leave_isr(void) __ONCHIP_CODE__;
  void chDbgCheckClassI(void) __ONCHIP_CODE__;
