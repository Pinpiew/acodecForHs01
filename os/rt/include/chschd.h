...
extern "C" {
  ...
  thread_t *chSchReadyI(thread_t *tp) __ONCHIP_CODE__;
  ...
  void chSchDoRescheduleAhead(void) __ONCHIP_CODE__;
  void chSchDoReschedule(void);
#if 1//CH_CFG_OPTIMIZE_SPEED == FALSE
  void queue_prio_insert(thread_t *tp, threads_queue_t *tqp) __ONCHIP_CODE__;
  void queue_insert(thread_t *tp, threads_queue_t *tqp) __ONCHIP_CODE__;
  thread_t *queue_fifo_remove(threads_queue_t *tqp) __ONCHIP_CODE__;
  thread_t *queue_lifo_remove(threads_queue_t *tqp) __ONCHIP_CODE__;
  thread_t *queue_dequeue(thread_t *tp) __ONCHIP_CODE__;
  void list_insert(thread_t *tp, threads_list_t *tlp) __ONCHIP_CODE__;
  thread_t *list_remove(threads_list_t *tlp) __ONCHIP_CODE__;
...
#if 0//CH_CFG_OPTIMIZE_SPEED == TRUE
