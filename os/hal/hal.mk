...
ifneq ($(findstring HAL_USE_AUDIO TRUE,$(HALCONF)),)
HALSRC += $(CHIBIOS)/os/hal/src/audio.c
HALSRC += $(CHIBIOS)/os/hal/src/audio_alg.c
HALSRC += $(CHIBIOS)/os/hal/src/audio_repair.c
endif
...
HALSRC += $(CHIBIOS)/os/hal/src/sf.c
endif
...
HALSRC += $(CHIBIOS)/os/hal/src/rf.c
endif
...
ifneq ($(findstring HAL_USE_USB_SERIAL TRUE,$(HALCONF)),)
...
HALSRC += $(CHIBIOS)/os/hal/src/usb_host.c
endif
ifneq ($(findstring HAL_USE_FM TRUE,$(HALCONF)),)
HALSRC += $(CHIBIOS)/os/hal/src/fm.c
endif
ifneq ($(findstring HAL_USE_USB_AUDIO TRUE,$(HALCONF)),)
HALSRC += $(CHIBIOS)/os/hal/src/usb_audio.c
endif
ifneq ($(findstring HAL_USE_USB_STORAGE TRUE,$(HALCONF)),)
HALSRC += $(CHIBIOS)/os/hal/src/usb_storage.c
endif
else
HALSRC = $(CHIBIOS)/os/hal/src/hal.c \
         $(CHIBIOS)/os/hal/src/hal_queues.c \
         ...
         $(CHIBIOS)/os/hal/src/usb_host.c \
         $(CHIBIOS)/os/hal/src/sf.c \
         $(CHIBIOS)/os/hal/src/audio.c \
         $(CHIBIOS)/os/hal/src/fm.c \
         $(CHIBIOS)/os/hal/src/audio_repair.c
         $(CHIBIOS)/os/hal/src/usb_audio.c
endif
