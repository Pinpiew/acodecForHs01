 ...
 */
typedef enum {
  SPI_TX_IDLE = 0,                 /**< Not transmitting.                  */
  SPI_TX_ACTIVE = 1,               /**< Transmitting.                      */
  SPI_TX_COMPLETE = 2              /**< Buffer complete.                   */
} spitxstate_t;
 ...
 */
typedef enum {
  SPI_RX_IDLE = 0,                 /**< Not receiving.                     */
  SPI_RX_ACTIVE = 1,               /**< Receiving.                         */
  SPI_RX_COMPLETE = 2              /**< Buffer complete.                   */
} spirxstate_t;
